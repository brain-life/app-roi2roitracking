classificationGenerator Executable
...
-run_classificationGenerator.sh (shell script for temporarily setting environment 
   ...
   -to run the shell script, type
    ...
    /mathworks/home/application/v96, run the shell script as:
       ...
       ./run_classificationGenerator.sh /mathworks/home/application/v96
...
${LD_LIBRARY_PATH}:MR/v96/runtime/glnxa64:MR/v96/bin/glnxa64:MR/v96/sys/os/glnxa64:MR/v96/sys/opengl/lib/glnxa64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_classificationGenerator.sh 
